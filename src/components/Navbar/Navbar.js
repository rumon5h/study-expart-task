...
const Navbar = () => {
  return (
    <navbar className="text-gray-600 ">
      <div className="container shadow-md rounder-md sticky top-0 shadow-orange-400 bg-white mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to="/log-in"><button className="px-6 py-2 text-sm uppercase text-orange-500 bg-orange-100 rounded shadow hover:bg-orange-200">
          {" "}
