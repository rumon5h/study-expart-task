    ...
    <div className="bg-white p-5 flex justify-center items-center h-[90vh] m-5">
     ...
     <form
      ...
      <div className="grid grid-cols-3 my-3 w-full">
          ...
          <button onClick={() => signInWithGoogle()} className="mt-3 border-2 py-3 cursor-pointer rounded-md uppercase px-10 block w-full  text-orange-500 bg-orange-100  shadow hover:bg-orange-200"> Continue with google</button>
     </div>
    </div>
  );
};
